...
const ManualPage: React.FC<ManualPageProps> = ({ data }) => {
  return (
    <div id={`page-${data.page}`} className="flex flex-col relative min-h-[1100px] mb-20 bg-white shadow-2xl mx-auto max-w-[900px] rounded-sm border border-gray-200 print:shadow-none print:border-none print:mb-0 page-break">
